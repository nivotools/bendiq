          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-800 border border-slate-700 rounded-xl py-3 pl-12 pr-12 text-white placeholder:text-slate-500 focus:outline-none focus:border-blue-500 transition-colors font-sans"
              />
              <button
                type="button"
            ...
            {isLogin && (
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  />
                  <label htmlFor="remember" className="text-slate-400 text-sm cursor-pointer font-sans">
                    Remember me
                  </label>
                </div>
                <button
            ...
            {!isLogin && (
              <div className="flex items-center gap-2">
                <Checkbox
                  ...
                  className="border-slate-600 data-[state=checked]:bg-blue-600 data-[state=checked]:border-blue-600"
                />
                <label htmlFor="remember-signup" className="text-slate-400 text-sm cursor-pointer font-sans">
                  Remember me
                </label>
              </div>
            )}
